    ...
    return (
        <EditView className="class-view">
            ...
            <div className="intro-row">
                <p>Update the information below to modify this class.</p>
            ...
            <div className="my-4 flex items-center">
                <Card className="class-form-card">
                    <CardHeader className="relative z-10">
                        <CardTitle className="text-2xl pb-0 font-bold">Update the form</CardTitle>
                    </CardHeader>
                        ...
                        <Form {...form}>
                            <form onSubmit={handleSubmit(onSubmit)}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Class Name<span className="text-orange-600">*</span>
                                            </FormLabel>
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            ...
                                            <FormItem>
                                            <FormLabel>Subject
                                            <span className="text-orange-600">*</span></FormLabel>
                                            <Select onValueChange={(value) =>
                                            field.onChange(Number(value))} value={field?.value?.toString()} disabled={subjectsLoading}>
                                        <FormControl>
                                        ...
                                        render={({ field }) => (
                                            ...
                                            <FormItem>
                                                <FormLabel>Teacher
                                                    <span className="text-orange-600">*</span></FormLabel>
                                                <Select onValueChange={(value) =>
                                                    field.onChange(value)} value={field?.value?.toString()} disabled={teachersLoading}>
                                                    <FormControl>
                                                        <SelectTrigger className="w-full">
